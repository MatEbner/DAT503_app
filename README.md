...
> DAT_503 Group 40 ESA1 -> https://dat503group40.streamlit.app/

## Generelle Information

Dieses Repository enthält die Daten und den Code für unser ESA 1 Projekt für DAT_503. Das Endergebnis ist einen Prototyp-Analyse-Dashboard, das unter anderem mit Hilfe eines Supervised Learning Modells den User als Entscheidungstool untersützen soll.

Das Projekt besteht aus zwei Hauptteilen, einmal das KI-Modell selbst und der Streamlit App.

Das Projekt kann sowohl lokal gestartet werden als auch [deployed](https://dat503group40.streamlit.app/) angesehen werden. Die deployte Version ist ein automatisierter Workflow, der immer den aktuell verfügbaren Datenbestand nutzt. Bei der lokalen Ausführung sind folgende Schritte auszuführen:
...
Um einen Überblick zu geben, werden folgend kurz die Ordnerstruktur, sowie die wichtigsten Files erklärt:
...
Mit Hilfe eines GitHub Action Workflows, das einen Cron-Job jeden Tag um 01:00 Uhr und 13:00 Mitteleuropäischer Zeit ausführt werden zwei Tasks ausgeführt:
...
Da am GitHub Remote Repository die neuen Daten mittels commit & push am main branch aktualisert werden, bezieht auch Streamlit die neuen Files. Der Prototyp wird mittels Streamlit Community Cloud, da mit dem Repository verknüpft ist, deployed.

## Lokaler Launch Guide
